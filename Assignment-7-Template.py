...
# Better change this to your program arguments.
...
# Just look at what you have in memory
...
# Avoud using this for-loop and use numpy to do this.
...
# Try to avoid this join operation.
# Find out a way that you can implement it without this join operation
# If you can not avoid it, then try to optimize your join. It is a join on two huge datasets with different sizes.
